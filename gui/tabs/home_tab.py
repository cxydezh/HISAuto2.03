...
class HomeTab(BaseTab):
    ...
    def _create_mouse_controls(self):
        ...
        ttk.Entry(frame, textvariable=self.action_mouse_x_var).grid(row=1, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_mouse_y_var).grid(row=2, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_mouse_time_diff_var).grid(row=3, column=1, sticky=tk.EW, padx=5, pady=5)
    ...
    def _create_keyboard_controls(self):
        ...
        ttk.Entry(frame, textvariable=self.action_keyboard_value_var).grid(row=1, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_keyboard_time_diff_var).grid(row=2, column=1, sticky=tk.EW, padx=5, pady=5)
    ...
    def _create_class_controls(self):
        ...
        ttk.Entry(frame, textvariable=self.action_class_name_var).grid(row=0, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_window_title_var).grid(row=1, column=1, sticky=tk.EW, padx=5, pady=5)
        
        # 时间差
        ttk.Label(frame, text="时间差:").grid(row=2, column=0, sticky=tk.W, padx=5, pady=5)
        self.action_class_time_diff_var = tk.StringVar(master=self.frame)
        ttk.Entry(frame, textvariable=self.action_class_time_diff_var).grid(row=2, column=1, sticky=tk.EW, padx=5, pady=5)
    ...
    def _create_ai_controls(self):
        ...
        ttk.Entry(frame, textvariable=self.action_ai_training_group_var).grid(row=0, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_ai_record_name_var).grid(row=1, column=1, sticky=tk.EW, padx=5, pady=5)
        
        # 长文本
        ttk.Label(frame, text="长文本:").grid(row=2, column=0, sticky=tk.W, padx=5, pady=5)
        self.action_ai_long_text_widget = tk.Text(frame, height=3, width=30)
        self.action_ai_long_text_widget.grid(row=2, column=1, sticky=tk.EW, padx=5, pady=5)
        
        # AI描述
        ttk.Label(frame, text="AI描述:").grid(row=3, column=0, sticky=tk.W, padx=5, pady=5)
        self.action_ai_description_var = tk.StringVar(master=self.frame)
        ttk.Entry(frame, textvariable=self.action_ai_description_var).grid(row=3, column=1, sticky=tk.EW, padx=5, pady=5)
        ...
        ttk.Entry(frame, textvariable=self.action_ai_time_diff_var).grid(row=4, column=1, sticky=tk.EW, padx=5, pady=5)
    ...
    def _create_image_controls(self):
        ...
        ttk.Entry(coord_frame, textvariable=self.action_image_left_top_x_var, width=10).grid(row=0, column=1, padx=5, pady=5)
        ...
        ttk.Entry(coord_frame, textvariable=self.action_image_left_top_y_var, width=10).grid(row=0, column=3, padx=5, pady=5)
        ...
        ttk.Entry(coord_frame, textvariable=self.action_image_right_bottom_x_var, width=10).grid(row=1, column=1, padx=5, pady=5)
        ...
        ttk.Entry(coord_frame, textvariable=self.action_image_right_bottom_y_var, width=10).grid(row=1, column=3, padx=5, pady=5)
